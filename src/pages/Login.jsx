  ...
  return (
    <div style={{ padding: '40px', maxWidth: '400px', margin: '0 auto', fontFamily: 'sans-serif' }}>
      ...
      <form onSubmit={handleLogin}>
        ...
        <button type="submit" disabled={loading} style={{ width: '100%', padding: '10px', background: '#0d2340', color: 'white', border: 'none', borderRadius: '5px' }}>
...
EOFcat <<'EOF' > src/pages/Login.jsx
import React, { useState } from 'react';
import { supabase } from '../lib/supabase';
import { useNavigate } from 'react-router-dom';
